    ...
    <div class="wrap">
        ...
        <form method="POST" action="{{ route('cadastro.store') }}">
            ...
            <div class="field">
                ...
                <input id="phone" name="phone" value="{{ old('phone') }}" required maxlength="32" placeholder="86999990000">
            </div>
            <div class="field">
            ...
            <div class="field">
                ...
                <input id="city" name="city" value="{{ old('city') }}" required maxlength="128">
            </div>
            <div class="field">
                <label for="experience_years">Anos de experiência</label>
                <input id="experience_years" type="number" min="0" name="experience_years" value="{{ old('experience_years', 0) }}">
            </div>
            <div class="field">
                <label for="profile_summary">Resumo do perfil (opcional)</label>
                <textarea id="profile_summary" name="profile_summary" rows="4" maxlength="2000">{{ old('profile_summary') }}</textarea>
            </div>
