...
<body>
    <div class="container">
        <div class="card">
            <div class="logo">
                <img src="<?php echo e(asset(config('branding.assets.logo.primary', '/images/logo-transparente.webp'))); ?>" alt="Carinho CRM" />
            </div>
            ...
            <div id="form-view">
                ...
                <div class="contract-info">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo e($contract->client?->lead?->name ?? 'Cliente'); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Tipo de Serviço</span>
                        <span class="info-value"><?php echo e($contract->proposal?->serviceType?->label ?? $contract->proposal?->serviceType?->name ?? '-'); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Início</span>
                        <span class="info-value"><?php echo e(optional($contract->start_date)->format('d/m/Y') ?? '-'); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Término</span>
                        <span class="info-value"><?php echo e(optional($contract->end_date)->format('d/m/Y') ?? '-'); ?></span>
                    </div>
                </div>
...
<?php /**PATH /var/www/html/resources/views/contracts/sign.blade.php ENDPATH**/ ?>