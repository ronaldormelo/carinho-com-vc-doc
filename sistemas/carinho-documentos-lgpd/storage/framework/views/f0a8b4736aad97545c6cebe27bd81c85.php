...
<head>
    ...
    <title>Politica de Privacidade - <?php echo e(config('branding.name')); ?></title>
    ...
    <main class="content-section">
        <div class="container">
            <div class="privacy-content">
                ...
                <h2>1. INTRODUCAO</h2>
                <p>
                    A <?php echo e(config('branding.name')); ?> esta comprometida em proteger sua privacidade. Esta politica
                ...
                <p>
                    <strong>E-mail:</strong> <a href="mailto:<?php echo e(config('branding.email.reply_to')); ?>"><?php echo e(config('branding.email.reply_to')); ?></a>
                </p>
...
<?php /**PATH /var/www/html/resources/views/public/privacy.blade.php ENDPATH**/ ?>