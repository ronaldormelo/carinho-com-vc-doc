    ...
    <div class="container">
        ...
        <div class="grid grid-4">
            <div class="card text-center">
                ...
                <h4>Repasse Justo</h4>
                <p class="text-muted">Receba de {{ $commissions['horista'] }}% a {{ $commissions['mensal'] }}% do valor do serviço.</p>
            </div>
...
<section class="section section-alt">
    <div class="container">
        ...
        <div class="highlight-box mt-8" style="max-width: 600px; margin-left: auto; margin-right: auto; text-align: center;">
            <p style="margin: 0;">
                <strong>Bônus adicional:</strong> Até +{{ $commissions['bonus']['rating'] }}% por avaliação alta e
    ...
    <div class="container">
        <div class="grid grid-2" style="gap: var(--spacing-12);">
            ...
            <div>
                ...
                <form id="caregiverLeadForm" method="POST" action="{{ route('lead.caregiver.submit') }}" aria-label="Formulário de cadastro de cuidador">
                    @csrf
                    ...
                    <div class="form-group">
                        <label class="form-checkbox">
                            ...
                            <span>Li e concordo com a <a href="{{ route('legal.privacy') }}" target="_blank">Política de Privacidade</a> e os <a href="{{ route('legal.caregiver-terms') }}" target="_blank">Termos para Cuidadores</a>. *</span>
                        </label>
                    </div>
            ...
            <div>
                <div class="card" style="background: var(--bg-secondary); margin-bottom: var(--spacing-6);">
                    ...
                    <p class="text-muted">Canal para quem quer trabalhar como cuidador(a).</p>
                    <a href="{{ route('whatsapp.cta', ['msg' => 'caregiver']) }}" class="btn btn-whatsapp btn-block" target="_blank" rel="noopener" aria-label="Falar pelo WhatsApp para se cadastrar como cuidador">
                ...
                <div class="card mt-4" style="background: var(--bg-secondary);">
                    ...
                    <p class="text-muted">
                        ...
                        <strong>Valor mínimo:</strong> R$ {{ number_format($payoutPolicy['min_value'], 2, ',', '.') }}<br>
                        <strong>Liberação:</strong> {{ $payoutPolicy['release_days'] }} dias após conclusão do serviço
                    </p>
