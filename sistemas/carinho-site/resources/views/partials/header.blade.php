<header class="header">
    <div class="container">
        <div class="header-inner">
            ...
            {{-- CTA Button --}}
            <a href="{{ app(\App\Services\WhatsAppService::class)->ctaUrlForCurrentPage() }}" class="btn btn-whatsapp md:block hidden" target="_blank" rel="noopener" aria-label="Falar pelo WhatsApp">
    ...
    <nav class="mobile-nav" id="mobileNav" aria-label="Navegação mobile" aria-hidden="true">
        ...
        <div style="padding-top: var(--spacing-6);">
            <a href="{{ app(\App\Services\WhatsAppService::class)->ctaUrlForCurrentPage() }}" class="btn btn-whatsapp btn-block" target="_blank" rel="noopener">
                Falar pelo WhatsApp
            </a>
        </div>
    </nav>
