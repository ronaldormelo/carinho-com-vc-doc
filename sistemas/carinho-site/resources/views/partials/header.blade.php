<header class="header">
        ...
        <div class="header-inner">
            ...
            <nav class="nav" aria-label="Navegacao principal">
                <ul class="nav-list">
                    ...
                    <li><a href="{{ route('services') }}" class="nav-link {{ request()->routeIs('services') ? 'active' : '' }}">Servicos</a></li>
            ...
            {{-- CTA Button --}}
            <a href="{{ route('whatsapp.cta') }}" class="btn btn-whatsapp md:block hidden" target="_blank" rel="noopener">
            ...
            {{-- Mobile Menu Toggle --}}
            <button class="nav-toggle" aria-label="Abrir menu" onclick="toggleMobileNav()">
                <span></span>
                <span></span>
                <span></span>
            </button>
    ...
    {{-- Mobile Navigation --}}
    <nav class="mobile-nav" id="mobileNav" aria-label="Navegacao mobile">
        <ul class="mobile-nav-list">
            <li><a href="{{ route('home') }}">Inicio</a></li>
            <li><a href="{{ route('about') }}">Quem Somos</a></li>
            <li><a href="{{ route('services') }}">Servicos</a></li>
