...
<section class="section">
    <div class="container" style="max-width: 800px;">
        ...
        <?php else: ?>
            ...
            <div class="mb-8">
                ...
                <details class="card mb-4" style="cursor: pointer;">
                    ...
                    <div style="padding-top: var(--spacing-4); color: var(--color-text-light);">
                        Cancelamento gratuito se feito com mais de 24 horas de antecedência. Entre 6 e 24 horas, reembolso de 50%. Com menos de 6 horas de antecedência, não há reembolso. Veja a <a href="<?php echo e(route('legal.cancellation')); ?>">política completa</a>.
                    </div>
                </details>
            ...
            <div class="mb-8">
                ...
                <details class="card mb-4" style="cursor: pointer;">
                    ...
                    <div style="padding-top: var(--spacing-4); color: var(--color-text-light);">
                        Preencha o <a href="<?php echo e(route('caregivers')); ?>">formulário de cadastro</a>. Nossa equipe analisará seu perfil e entrará em contato para os próximos passos, que incluem verificação de documentos e assinatura de contrato.
                    </div>
                </details>
        ...
        <div class="highlight-box text-center" style="margin-top: var(--spacing-12);">
            ...
            <a href="<?php echo e(route('whatsapp.cta')); ?>" class="btn btn-whatsapp" target="_blank" rel="noopener">
                Falar pelo WhatsApp
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/faq.blade.php ENDPATH**/ ?>