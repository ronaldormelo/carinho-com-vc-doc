    ...
    <div class="container">
        <div style="max-width: 800px; margin: 0 auto; text-align: center;">
            ...
            <div class="card" style="background: white; color: var(--color-text); text-align: left; max-width: 600px; margin: 0 auto;">
                ...
                <form id="investorContactForm" method="POST" action="<?php echo e(route('lead.investor.submit')); ?>" aria-label="Formulário de contato para investidores">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        <label class="form-checkbox">
                            ...
                            <span>Concordo em receber informações sobre investimento e aceito a <a href="<?php echo e(route('legal.privacy')); ?>" target="_blank" style="color: var(--color-primary);">Política de Privacidade</a>. *</span>
                        </label>
                    </div>
            ...
            <div style="margin-top: var(--spacing-8);">
                ...
                <p style="font-size: var(--font-size-lg);">
                    ...
                    <strong>WhatsApp:</strong> <?php echo e(config('branding.contact.whatsapp_display')); ?>
...
document.getElementById('investorContactForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const token = await grecaptcha.execute('<?php echo e(config('integrations.recaptcha.site_key')); ?>', {action: 'submit_investor'});
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/investors.blade.php ENDPATH**/ ?>