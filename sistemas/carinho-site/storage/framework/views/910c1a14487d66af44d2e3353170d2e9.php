...
<section class="section">
    <div class="container">
        <div class="grid grid-3">
            ...
            <div class="card" style="<?php echo e($key === 'diario' ? 'border: 2px solid var(--color-primary);' : ''); ?>">
                <?php if($key === 'diario'): ?>
                ...
                <h3 class="card-title"><?php echo e($service['label']); ?></h3>
                ...
                <ul style="color: var(--color-text-light); padding-left: 20px; margin-bottom: var(--spacing-4);">
                    <li>Mínimo de <?php echo e($service['min_hours']); ?> horas</li>
                    <li>Cuidadores qualificados</li>
                    <li>Substituição garantida</li>
                </ul>

                <a href="<?php echo e(route('whatsapp.cta')); ?>" class="btn <?php echo e($key === 'diario' ? 'btn-primary' : 'btn-secondary'); ?> btn-block" target="_blank" rel="noopener">
                    Solicitar orçamento
                </a>
            </div>
    ...
    <div class="container">
        ...
        <div class="grid grid-3">
            ...
            <div class="card">
                ...
                <a href="<?php echo e(route('legal.cancellation')); ?>">Ver política completa</a>
            </div>
            ...
            <div class="card">
                ...
                <a href="<?php echo e(route('legal.emergency')); ?>">Ver política completa</a>
            </div>
        </div>
    </div>
</section>
...
<section class="cta-section">
    <div class="container">
        ...
        <div style="display: flex; gap: var(--spacing-4); justify-content: center; flex-wrap: wrap;">
            <a href="<?php echo e(route('whatsapp.cta')); ?>" class="btn btn-secondary btn-lg" target="_blank" rel="noopener">
                Falar pelo WhatsApp
            </a>
            <a href="<?php echo e(route('clients')); ?>" class="btn btn-primary btn-lg" style="background: white; color: var(--color-primary);">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/services.blade.php ENDPATH**/ ?>