...
<section class="section">
    <div class="container">
        <div class="legal-content">
            <p class="text-muted">Última atualização: <?php echo e(date('d/m/Y')); ?></p>
            ...
            <table class="policy-table">
                <tbody>
                    <?php $__currentLoopData = $policy['channels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channel => $description): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><strong><?php echo e(ucfirst($channel)); ?></strong></td>
                        <td>
                            <?php if($channel === 'whatsapp'): ?>
                            <?php echo e(config('branding.contact.whatsapp_display')); ?> - <?php echo e($description); ?>

                            <?php elseif($channel === 'email'): ?>
                            <a href="mailto:<?php echo e(config('branding.contact.email_emergency')); ?>"><?php echo e(config('branding.contact.email_emergency')); ?></a>
                            <?php else: ?>
            ...
            <table class="policy-table">
                ...
                <tbody>
                    <tr style="background: #f8d7da;">
                        ...
                        <td><strong><?php echo e($policy['response_time']['critical']); ?></strong></td>
                        <td>Emergência médica, segurança em risco</td>
                    </tr>
                    <tr style="background: #fff3cd;">
                        <td><strong style="color: var(--color-warning);">Alto</strong></td>
                        <td><strong><?php echo e($policy['response_time']['high']); ?></strong></td>
                        <td>Ausência de cuidador, atraso significativo</td>
                    </tr>
                    <tr>
                        <td><strong>Medio</strong></td>
                        <td><strong><?php echo e($policy['response_time']['medium']); ?></strong></td>
            ...
            <?php $__currentLoopData = $policy['types']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card mb-4" style="<?php echo e($type['severity'] === 'critical' ? 'border-left: 4px solid var(--color-danger);' : ($type['severity'] === 'high' ? 'border-left: 4px solid var(--color-warning);' : '')); ?>">
                <h4 style="margin-top: 0;"><?php echo e($type['type']); ?></h4>
                <p class="text-muted" style="margin-bottom: 0;"><strong>Ação:</strong> <?php echo e($type['action']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <p>
                ...
                conforme <a href="<?php echo e(route('legal.cancellation')); ?>">Política de Cancelamento</a>.
            </p>
            ...
            <table class="policy-table">
                <tbody>
                    <?php $__currentLoopData = $policy['escalation']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level => $description): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><strong><?php echo e(str_replace('_', ' ', ucfirst($level))); ?></strong></td>
            ...
            <table class="policy-table">
                <tbody>
                    <tr>
                        ...
                        <td><?php echo e($sla['business_hours']['start']); ?> - <?php echo e($sla['business_hours']['end']); ?></td>
                    </tr>
                    <tr>
                        <td><strong>Primeira resposta</strong></td>
                        <td><?php echo e($sla['first_response']); ?> minutos</td>
                    </tr>
                    <tr>
                        <td><strong>Resolução simples</strong></td>
                        <td><?php echo e($sla['resolution']); ?> minutos</td>
                    </tr>
                </tbody>
            </table>
            <p class="text-muted">
            ...
            <div class="highlight-box" style="background: #f8d7da; border-color: var(--color-danger);">
                <p style="font-size: var(--font-size-lg); margin-bottom: var(--spacing-2);">
                    <strong>WhatsApp Emergência:</strong> <?php echo e(config('branding.contact.whatsapp_display')); ?>

                </p>
                <p style="margin: 0;">
                    <strong>E-mail:</strong> <a href="mailto:<?php echo e(config('branding.contact.email_emergency')); ?>"><?php echo e(config('branding.contact.email_emergency')); ?></a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/legal/emergency.blade.php ENDPATH**/ ?>