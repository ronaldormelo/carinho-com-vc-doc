...
<section class="section">
    <div class="container">
        <div class="legal-content">
            ...
            <p>
                <strong>E-mail:</strong> <a href="mailto:<?php echo e(config('branding.contact.email_privacy')); ?>"><?php echo e(config('branding.contact.email_privacy')); ?></a>
            </p>
            <p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/legal/privacy.blade.php ENDPATH**/ ?>