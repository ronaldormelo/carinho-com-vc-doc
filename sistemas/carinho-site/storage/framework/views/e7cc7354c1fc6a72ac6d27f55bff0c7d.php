...
<section class="section">
    <div class="container">
        <div class="legal-content">
            ...
            <p>
                Consulte a <a href="<?php echo e(route('legal.payment')); ?>">Política de Pagamento</a> para mais detalhes.
            </p>

            <h2>7. CANCELAMENTO E REEMBOLSO</h2>
            <p>
                Os cancelamentos estão sujeitos à nossa <a href="<?php echo e(route('legal.cancellation')); ?>">Política de Cancelamento</a>.
                Em resumo:
            </p>
            <ul>
            ...
            <p>
                <strong>E-mail:</strong> <a href="mailto:<?php echo e(config('branding.contact.email')); ?>"><?php echo e(config('branding.contact.email')); ?></a><br>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/legal/terms.blade.php ENDPATH**/ ?>