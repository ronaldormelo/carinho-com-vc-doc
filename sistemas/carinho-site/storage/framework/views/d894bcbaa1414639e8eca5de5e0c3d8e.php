    ...
    <div class="container">
        <div class="legal-content">
            ...
            <table class="policy-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $policy['rules']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($rule['condition']); ?></td>
                        <td><strong><?php echo e($rule['refund']); ?>%</strong></td>
            ...
            <div class="highlight-box">
                <p style="margin: 0;">
                    <strong>Taxa administrativa:</strong> Aplica-se taxa de <?php echo e($policy['admin_fee']); ?>%
            ...
            <ol>
                <li>Entre em contato pelo WhatsApp: <?php echo e(config('branding.contact.whatsapp_display')); ?></li>
            ...
            <p>
                <?php echo e($policy['caregiver_cancellation']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/legal/cancellation.blade.php ENDPATH**/ ?>