...
<nav aria-label="Breadcrumb" style="background: var(--bg-secondary); padding: var(--spacing-3) 0;">
    <div class="container">
        <ol style="list-style: none; padding: 0; margin: 0; display: flex; gap: var(--spacing-2); font-size: var(--font-size-sm); color: var(--color-text-muted);">
            ...
            <li aria-current="page" style="color: var(--color-primary);">Para Cuidadores</li>
        </ol>
    </div>
</nav>
...
<section class="section" style="background: linear-gradient(135deg, var(--bg-secondary) 0%, var(--bg-primary) 100%); padding-bottom: var(--spacing-8);">
    <div class="container">
        ...
        <p class="text-light" style="font-size: var(--font-size-xl); max-width: 600px;">
            Junte-se à nossa equipe e tenha mais oportunidades de trabalho com recorrência e suporte profissional.
        </p>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="grid grid-4">
            <div class="card text-center">
                ...
                <h4>Repasse Justo</h4>
                <p class="text-muted">Receba de <?php echo e($commissions['horista']); ?>% a <?php echo e($commissions['mensal']); ?>% do valor do serviço.</p>
            </div>
            ...
            <div class="card text-center">
                ...
                <p class="text-muted">Repasse semanal às sextas-feiras, sem atrasos.</p>
            </div>
            ...
            <div class="card text-center">
                ...
                <p class="text-muted">Canal exclusivo para dúvidas e orientações.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section section-alt">
    <div class="container">
        <h2 class="text-center mb-8">Quanto você recebe</h2>

        <div class="grid grid-3">
            <div class="card text-center">
                <h3 style="color: var(--color-primary); font-size: var(--font-size-4xl); margin-bottom: var(--spacing-2);"><?php echo e($commissions['horista']); ?>%</h3>
                <h4>Horista</h4>
                <p class="text-muted">Atendimentos por hora</p>
            </div>

            <div class="card text-center" style="border: 2px solid var(--color-primary);">
                <h3 style="color: var(--color-primary); font-size: var(--font-size-4xl); margin-bottom: var(--spacing-2);"><?php echo e($commissions['diario']); ?>%</h3>
                <h4>Diario</h4>
                <p class="text-muted">Turnos diurnos ou noturnos</p>
            </div>

            <div class="card text-center">
                <h3 style="color: var(--color-primary); font-size: var(--font-size-4xl); margin-bottom: var(--spacing-2);"><?php echo e($commissions['mensal']); ?>%</h3>
                <h4>Mensal</h4>
        ...
        <div class="highlight-box mt-8" style="max-width: 600px; margin-left: auto; margin-right: auto; text-align: center;">
            <p style="margin: 0;">
                <strong>Bônus adicional:</strong> Até +<?php echo e($commissions['bonus']['rating']); ?>% por avaliação alta e
                +<?php echo e($commissions['bonus']['tenure']); ?>% por tempo de casa!
            </p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="grid grid-2" style="gap: var(--spacing-12);">
            ...
            <div>
                ...
                <form id="caregiverLeadForm" method="POST" action="<?php echo e(route('lead.caregiver.submit')); ?>" aria-label="Formulário de cadastro de cuidador">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-input" required placeholder="seu@email.com" autocomplete="email">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="availability" name="availability" class="form-textarea" placeholder="Dias e horários disponíveis para trabalhar"></textarea>
                    </div>

                    <div class="form-group">
                        <label class="form-checkbox">
                            <input type="checkbox" name="consent" required>
                            <span>Li e concordo com a <a href="<?php echo e(route('legal.privacy')); ?>" target="_blank">Política de Privacidade</a> e os <a href="<?php echo e(route('legal.caregiver-terms')); ?>" target="_blank">Termos para Cuidadores</a>. *</span>
                        </label>
                    </div>
                    ...
                    <div id="formMessageCaregiver" class="mt-4" style="display: none;" role="alert" aria-live="polite"></div>
                </form>
            </div>
            ...
            <div>
                <div class="card" style="background: var(--bg-secondary); margin-bottom: var(--spacing-6);">
                    ...
                    <ul style="color: var(--color-text-light); padding-left: 20px;">
                        <li>Mínimo 1 ano de experiência comprovada</li>
                        <li>Curso de cuidador de idosos (desejável)</li>
                ...
                <div class="card">
                    ...
                    <ol style="color: var(--color-text-light); padding-left: 20px;">
                        <li style="margin-bottom: var(--spacing-3);">Você envia o cadastro</li>
                        ...
                        <li style="margin-bottom: var(--spacing-3);">Solicitamos documentos para verificação</li>
                        <li style="margin-bottom: var(--spacing-3);">Assinamos contrato digital</li>
                        <li>Você começa a receber oportunidades!</li>
                    </ol>
                </div>

                <div class="card mt-4" style="background: var(--bg-secondary);">
                    <h4>Política de Repasse</h4>
                    <p class="text-muted">
                        <strong>Frequência:</strong> Semanal (sextas-feiras)<br>
                        <strong>Valor mínimo:</strong> R$ <?php echo e(number_format($payoutPolicy['min_value'], 2, ',', '.')); ?><br>
                        <strong>Liberação:</strong> <?php echo e($payoutPolicy['release_days']); ?> dias após conclusão do serviço
                    </p>
                    <a href="<?php echo e(route('legal.payment')); ?>">Ver política completa</a>
                </div>
            </div>
        </div>
    </div>
...
document.getElementById('caregiverLeadForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const token = await grecaptcha.execute('<?php echo e(config('integrations.recaptcha.site_key')); ?>', {action: 'submit_caregiver'});
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/caregivers.blade.php ENDPATH**/ ?>