...
<section class="section">
    <div class="container">
        <div class="legal-content">
            ...
            <ul>
                <li>Até +<?php echo e($commission['bonus']['rating']); ?>% por avaliação alta (média acima de 4.5)</li>
                <li>Até +<?php echo e($commission['bonus']['tenure']); ?>% por tempo de casa (após 1 ano)</li>
            </ul>
            ...
            <table class="policy-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($payoutPolicy['release_days']); ?> dias após conclusão do serviço</td>
                    </tr>
                </tbody>
            </table>
