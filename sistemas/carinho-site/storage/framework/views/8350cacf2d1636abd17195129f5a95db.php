    ...
    <div class="container">
        <div class="grid grid-2" style="gap: var(--spacing-12);">
            ...
            <div>
                ...
                <form id="clientLeadForm" method="POST" action="<?php echo e(route('lead.client.submit')); ?>" aria-label="Formulário de solicitação de cuidador">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="urgency_id" name="urgency_id" class="form-select" required aria-describedby="urgency_help">
                            ...
                            <?php $__currentLoopData = $urgencyLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $urgency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($loop->iteration); ?>"><?php echo e($urgency['label']); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="service_type_id" name="service_type_id" class="form-select" required>
                            <option value="">Selecione...</option>
                            <?php $__currentLoopData = $serviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($loop->iteration); ?>"><?php echo e($service['label']); ?> - <?php echo e($service['description']); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="form-checkbox">
                            ...
                            <span id="consent_text">Li e concordo com a <a href="<?php echo e(route('legal.privacy')); ?>" target="_blank">Política de Privacidade</a> e os <a href="<?php echo e(route('legal.terms')); ?>" target="_blank">Termos de Uso</a>. *</span>
                        </label>
                    </div>
            ...
            <div>
                ...
                <div class="highlight-box mt-4">
                    <p style="margin: 0;"><strong>Atenção:</strong> O pagamento é sempre adiantado, com antecedência de 24h antes do serviço. <a href="<?php echo e(route('legal.payment')); ?>">Saiba mais</a></p>
                </div>
            </div>
        </div>
    </div>
...
document.getElementById('clientLeadForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const token = await grecaptcha.execute('<?php echo e(config('integrations.recaptcha.site_key')); ?>', {action: 'submit_lead'});
